...
namespace Library_gRPC_API.Services;

public class UserLibraryService : LibrarygRPCAPI.Protos.LibraryService.LibraryServiceBase
{
    private readonly IMongoDatabase _db;
    private readonly ILogger<UserLibraryService> _logger;
    public UserLibraryService(IMongoDatabase db, ILogger<UserLibraryService> logger)
    {
